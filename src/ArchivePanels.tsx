...
export function CompleteArtistArchive({ artist }: { artist: Artist }) {
  const deepArchive = archiveBatch41[artist.id] ?? archiveBatch40[artist.id] ?? archiveBatch39[artist.id] ?? archiveBatch38[artist.id] ?? archiveBatch37[artist.id] ?? archiveBatch36[artist.id] ?? archiveBatch35[artist.id] ?? archiveBatch34[artist.id] ?? archiveBatch33[artist.id] ?? archiveBatch32[artist.id] ?? archiveBatch31[artist.id] ?? archiveBatch30[artist.id] ?? archiveBatch29[artist.id] ?? archiveBatch28[artist.id] ?? artistArchives[artist.id];
